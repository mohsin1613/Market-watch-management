...
<?php
$db = new Database();
$query = "select *from cci_information";
...
<table class="table table-bordered table-striped table-hover">
    ...
    ?> <tr>
            ...
            <td><?php echo $row['cci_info']; ?></td>
            <td><?php echo $row['info_type']; ?></td>
            <td><a href="editcci.php?id=<?php echo $row['id'];?><button type="button" class="btn btn-primary btn-sm"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label style="color:green;" class="control-label col-sm-2">CCI Information</label>
                        <div class="col-sm-8">

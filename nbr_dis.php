...
<?php
$db = new Database();
$query = "select *from nbr_information";
...
<table class="table table-bordered table-striped table-hover">
    ...
    ?> <tr>
            ...
            <td><?php echo $row['nbr_info']; ?></td>
            <td><?php echo $row['info_type']; ?></td>
            <td><a href="editnbr.php?id=<?php echo $row['id'];?><button type=" button" class="btn btn-primary btn-sm"
                    id="<?php echo $row['id'];?>"><?php echo $row['Edit']; ?></button></a></td>
        </tr>
        <?php  
      }
    } else {
      echo "NOT Available the NBR distribution sheet.";
    }
    ?>
    </tbody>
</table>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label style="color:green;" class="control-label col-sm-2">NBR Information</label>
                        <div class="col-sm-8">
                            <input type="agri" class="form-control" id="agri" placeholder="Enter the information...">
                        </div>
                    </div>
                    <div class="form-group">

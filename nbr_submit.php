...
<div style="background-image: linear-gradient(to bottom right, darkred, darkorange);">
    <div class="row">
        <div class="col-md-9">
            <form method="post" action=""><br><br><br>
                ...
                <div class="row">
                    <label class="col-sm-3 colr">Import cost:</label>
                    <input type="number" class="col-sm-3" placeholder="cost(number)..." required>
                    <label class="col-sm-3 colr">Export cost:</label>
                    <input type="number" class="col-sm-3" placeholder="cost(number)..." required>
                </div><br><br>
                <div class="row">
                    <label class="col-sm-3 colr">product tax:</label>
                    <input type="number" class="col-sm-3" placeholder="tax(number)..." required>
                    <label class="col-sm-3 colr">Import tax:</label>
                    <input type="number" class="col-sm-3 " placeholder="tax(number)..." required>
                </div><br><br>
                <div class="row">
                    <label class="col-sm-3 colr">Export tax:</label>
                    <input type="number" class="col-sm-3" placeholder="tax(number)..." required>
                    <label class="col-sm-3 colr">product vat:</label>
                    <input type="number" class="col-sm-3" placeholder="vat(number)..." required>
                </div><br><br>
